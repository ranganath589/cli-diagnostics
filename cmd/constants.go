...
//root
const (
	rootShortDescription = "The Diagnostic Tools CLI allows you to diagnose server, ESI, DNS - rchenna, and network issues Akamai customers experience when delivering content to their end users."
	rootLongDescription  = `The Diagnostic Tools CLI allows you to diagnose server, ESI, DNS - rchenna-NEW, and network issues Akamai customers experience when delivering content to their end users.
